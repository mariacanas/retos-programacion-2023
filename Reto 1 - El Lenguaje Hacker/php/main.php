...
function convertoHacker($frase){
    $fraseHacker = "";

    $frase = strtolower($frase);
    foreach(str_split($frase) as $letra){
        $fraseHacker .= array_key_exists($letra, diccionarioMap) ? diccionarioMap[$letra] : "";
    }
...
$userInput = readline();
echo "La frase en hacker es: " .convertoHacker($userInput);
